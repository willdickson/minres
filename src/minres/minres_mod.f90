...
! File minres_mod.f90
!
! minres_solver solves symmetric systems Ax = b or min ||Ax - b||_2,
...
! 16 Oct 2007: Use minres_data_mod to define dp = selected_real_kind(15).
!              We need "use minres_data_mod"
!              at the beginning of modules AND inside interfaces.
!
!              g95 compiles successfully with the following options:
!   g95 -c -g -O0 -pedantic -Wall -Wextra -fbounds-check -ftrace=full minres_mod.f90
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
contains
  ...
  subroutine minres_solver( n, Aprod, Msolve, b, shift, checkA, precon, &
                     x, itnlim, nout, rtol,                             &
